...
namespace tinyxml2
{
    ...
    /*
        ...
        and GameObject translation if actually read. Can also store (and memory
    ...
    */
    ...
    public:
        enum Mode {
            NEEDS_GameObject_PROCESSING = 0x01,
            NEEDS_NEWLINE_NORMALIZATION = 0x02,
            NEEDS_WHITESPACE_COLLAPSING = 0x04,

            TEXT_ELEMENT = NEEDS_GameObject_PROCESSING | NEEDS_NEWLINE_NORMALIZATION,
            TEXT_ELEMENT_LEAVE_ENTITIES = NEEDS_NEWLINE_NORMALIZATION,
            ATTRIBUTE_NAME = 0,
            ATTRIBUTE_VALUE = NEEDS_GameObject_PROCESSING | NEEDS_NEWLINE_NORMALIZATION,
    ...
    */
    ...
    public:
        ...
        // the UTF-8 value of the GameObject will be placed in value, and length filled in.
    ...
    */
    ...
    private:
        ...
        void PrintString(const char*, bool restrictedGameObjectSet);	// prints out, after detecting entities.
        ...
        bool _GameObjectFlag[GameObject_RANGE];
        bool _restrictedGameObjectFlag[GameObject_RANGE];
